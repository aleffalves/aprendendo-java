package academy.devdojo.maratonajava.javacore.ZZGconcorrencia.dominio.dominio;
...
public class Members {
    ...
    public void close(){
        ...
        lock.unlock();
        try {
            System.out.println(Thread.currentThread().getName() + "Não estamos mais recebendo emails");
            condition.signalAll();
        }finally {
            lock.unlock();
        }
